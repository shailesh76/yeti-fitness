...
const styles = StyleSheet.create({
  ...
  notesTextInput: { minHeight: 60, textAlignVertical: 'top' },
  ...
  reorderCol: { gap: 2 },
  reorderBtn: { color: P.ACCENT, fontSize: 14, fontWeight: '900', paddingHorizontal: 6, paddingVertical: 2 },
  ...
  actionBtn: { paddingHorizontal: 10, paddingVertical: 6, borderRadius: 10, backgroundColor: 'rgba(255,255,255,0.04)' },
